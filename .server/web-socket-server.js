...
module.exports = class WebSocketServer {
    constructor() {
        ...
        this._users = [{
            userId: 'user_001',
            nickName: '华章昭二号',
            myHeadUrl: 'https://c-ssl.dtstatic.com/uploads/item/201707/15/20170715072330_tZsch.thumb.1000_0.jpeg'
        }, {
            userId: 'user_002',
            nickName: '华章昭一号',
            myHeadUrl: 'https://img9.doubanio.com/view/group_topic/l/public/p377123134.webp'
        }];
